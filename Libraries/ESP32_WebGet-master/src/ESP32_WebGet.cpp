...
void ESP32_WebGet::WeatherJ_font_num(String str, uint8_t wDay, uint8_t Htime, uint8_t Fnum[3], uint8_t color[3]){
//  uint8_t Sunny_red = 7, Sunny_green = 3, Sunny_blue = 0; //256bit color 晴れ           // color = 0b11101100 = 0xec = 0b1111101111100000 = 0xfbe0 palette 5
//  uint8_t Cloudy_red = 3, Cloudy_green = 3, Cloudy_blue = 1; //256bit color 曇り        // color = 0b01101101 = 0x6d = 0b0111101111101111 = 0x7bef palette 6
//  uint8_t Rain_red = 0, Rain_green = 0, Rain_blue = 3; //256bit color 雨、大雨、暴風雨  // color = 0b00000011 = 0x03 = 0b0000000000011111 = 0x001f palette 7
//  uint8_t Snow_red = 7, Snow_green = 7, Snow_blue = 3; //256bit color 雪                // color = 0b11111111 = 0xff = 0b1111111111111111 = 0xffff palette 3
//  uint8_t Thunder_red = 7, Thunder_green = 7, Thunder_blue = 0; //256bit color 雷       // color = 0b11111100 = 0xfc = 0b1111111111100000 = 0xffe0 palette 8
//  col[1][0] = 7; col[1][1] = 7; col[1][2] = 3;                                          // color = 0b11111111 = 0xff = 0b1111111111111111 = 0xffff palette 3
uint8_t col;
